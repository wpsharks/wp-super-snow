			...
			public function options()
				{
					...
					echo '                  <p class="info">'.__('<strong>Tip:</strong> images that have the word <code>flake</code> in their filename are spinned in a 3D rotation at random. All other graphics rotate left-to-right and/or right-to-left at random.', plugin()->text_domain).'</p>'."\n";
