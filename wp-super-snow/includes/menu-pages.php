			...
			public function options()
				{
					...
					echo '      <p>'.__('By default (if it\'s enabled) WP Super Snow is displayed on every page of your site (and for all browsers/devices). However, if there are conditions you\'d like to satisify before WP Super Snow is loaded (e.g. only load it on certain Posts/Pages; or only between specific dates/times); you can specify those conditions here using <a href="http://codex.wordpress.org/Conditional_Tags" target="_blank">Conditional Tags</a>.', plugin()->text_domain).'</p>'."\n";
