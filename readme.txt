...
1. WP Super Snow Screenshot #1
2. WP Super Snow Screenshot #2
3. WP Super Snow Screenshot #3
4. WP Super Snow Screenshot #4
5. WP Super Snow Screenshot #5
6. WP Super Snow Screenshot #6
7. WP Super Snow Screenshot #7

== Installation ==

= WP Super Snow is Very Easy to Install =

1. Upload the `/wp-super-snow` folder to your `/wp-content/plugins/` directory.
2. Activate the plugin through the Plugins menu in WordPress®.
3. Navigate to the **WP Super Snow** panel & configure.
...
* **Initial Release.** Just in time for the holiday season :-)
