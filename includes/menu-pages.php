			...
			public function options()
				{
					...
					echo '      <p style="float:right; margin:-5px 0 0 0; font-weight:bold;">WP Super Snow = <i class="fa fa-smile-o fa-4x"></i> happy visitors<em>!</em></p>'."\n";
					...
					echo '                  <p>'.__('This is almost always the <code>body</code> tag. However, you might change this if you have a specific area of your site that WP Super Snow should be restricted to. Note: if you change this, please use a CSS selector expression that is compatible with jQuery; e.g. <code>#my_div</code> or <code>#my_div &lt; div.snow</code> (as quick examples).', plugin()->text_domain).'</p>'."\n";
					...
					echo '                  <p>'.__('Snowflake sizes are always random. However, you can control the randomizer (to a certain extent) by defining the largest possible size. Note: the default snowflake graphics that come with WP Super Snow will support up to <code>100</code> pixels as a max size.', plugin()->text_domain).'</p>'."\n";
					...
					echo '                  <p>'.__('Snowflake animations are always random. However, you can control the randomizer (to a certain extent) by defining the longest possible duration of a falling snowflake. Note: a largest number = a slower speed; a smaller number = faster (e.g. a shorter duration).', plugin()->text_domain).'</p>'."\n";
					...
					echo '                  <p>'.__('Snowflake animations always include transpareny effects. This setting enables/disables some ADDITIONAL snowflake image transparency effects for an enhanced viewing experience.', plugin()->text_domain).'</p>'."\n";
