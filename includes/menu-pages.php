			...
			public function options()
				{
					...
					echo '                  <p>'.__('Snowflakes are animated in and out of view at random intervals. What is the total number of snowflakes that should be processed internally? Note: the more snowflakes you process — the slower your site might become (particularly on slower computers).', plugin()->text_domain).'</p>'."\n";
