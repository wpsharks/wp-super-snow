			...
			public function options()
				{
					...
					echo '                  <p>'.__('This is almost always the <code>body</code> tag. However, you might decided to change this if you have a specific area of your site that WP Super Snow should be restricted to. Note: if you DO change this, please use a CSS selector expression for jQuery; e.g. <code>#my_div</code>', plugin()->text_domain).'</p>'."\n";
